package com.study.shopping.order.aspect;

import com.study.shopping.common.exception.BizCodeEnume;
import com.study.shopping.common.exception.TokenException;
...
public class TokenAspect {
    ...
    // 切入点签名
    @Pointcut("@annotation(com.study.shopping.order.annotation.TokenVerify)")
